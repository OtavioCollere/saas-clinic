...
type ActivateFranchiseUseCaseResponse = Either<
...
export class ActivateFranchiseUseCase {
  constructor(
  ...
  async execute({
    franchiseId,
    userId,
  }: ActivateFranchiseUseCaseRequest): Promise<ActivateFranchiseUseCaseResponse> {
