        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background:#fff;border-radius:0 0 12px 12px;padding:36px 40px;box-shadow:0 4px 16px rgba(0,0,0,0.06);">
              ...
              <h2 style="margin:0 0 8px;color:#0f172a;font-size:22px;">Bem-vindo ao Cliniker! ðŸ‘‹</h2>
              <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.6;">
                Seu cadastro como <strong>paciente</strong> foi realizado. Use as credenciais abaixo para acessar o sistema e completar seu perfil.
              </p>
...
export class OnPatientCreated {
  ...
  async handle(event: PatientCreatedEvent) {
    console.log('ðŸ“¬ Handler OnPatientCreated executado:', {
    ...
    try {
      console.log('ðŸ“§ Adicionando email de boas-vindas Ã  fila...');
