...
- [ ] Use Cases
  - [ ] create-anamnesis
  - [ ] edit-anamnesis
  - [ ] get-anamnesis-by-patient-id
- [ ] Controllers
  - [ ] create-anamnesis.controller
  - [ ] edit-anamnesis.controller
  - [ ] get-anamnesis-by-patient-id.controller
- [ ] Testes Unitários
  - [ ] create-anamnesis.spec
  - [ ] edit-anamnesis.spec
  - [ ] get-anamnesis-by-patient-id.spec
- [ ] Testes E2E
  - [ ] create-anamnesis.e2e
  - [ ] edit-anamnesis.e2e
  - [ ] get-anamnesis-by-patient-id.e2e



    
#   - RBAC + decorators
#   - Imdepotencia no appointment
#   - feature flag
...
# Troca de email com certificacao
# deploy aws
# deploy cloud run 
# observabilidade 
# healt check
